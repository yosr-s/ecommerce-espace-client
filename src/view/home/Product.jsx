          ...
          <div className="product product-single row">
                  ...
                  <div className="swiper-wrapper row cols-1 gutter-no">
                    <div className="swiper-slide">
                      <figure className="product-image">
                        <img src="assets/images/products/vertical_thumb/1-800x900.jpg" data-zoom-image="assets/images/products/vertical_thumb/1-800x900.jpg" alt="Electronics Black Wrist Watch" width={800} height={900} />
                      </figure>
                    </div>
                    <div className="swiper-slide">
                      <figure className="product-image">
                        <img src="assets/images/products/vertical_thumb/2-800x900.jpg" data-zoom-image="assets/images/products/vertical_thumb/2-800x900.jpg" alt="Electronics Black Wrist Watch" width={488} height={549} />
                      </figure>
                    </div>
                    <div className="swiper-slide">
                      <figure className="product-image">
                        <img src="assets/images/products/vertical_thumb/3-800x900.jpg" data-zoom-image="assets/images/products/vertical_thumb/3-800x900.jpg" alt="Electronics Black Wrist Watch" width={800} height={900} />
                      </figure>
                    </div>
                    <div className="swiper-slide">
                      <figure className="product-image">
                        <img src="assets/images/products/vertical_thumb/4-800x900.jpg" data-zoom-image="assets/images/products/vertical_thumb/4-800x900.jpg" alt="Electronics Black Wrist Watch" width={800} height={900} />
                      </figure>
                    </div>
                  </div>
                ...
                <div className="product-thumbs-wrap swiper-container" data-swiper-options="{
                  ...
                  <div className="product-thumbs swiper-wrapper row cols-lg-1 cols-4 gutter-sm">
                    <div className="product-thumb swiper-slide">
                      <img src="assets/images/products/vertical_thumb/1-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                    </div>
                    <div className="product-thumb swiper-slide">
                      <img src="assets/images/products/vertical_thumb/2-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                    </div>
                    <div className="product-thumb swiper-slide">
                      <img src="assets/images/products/vertical_thumb/3-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                    </div>
                    <div className="product-thumb swiper-slide">
                      <img src="assets/images/products/vertical_thumb/4-800x900.jpg" alt="Product Thumb" width={800} height={900} />
                    </div>
                  </div>
                  <button className="swiper-button-prev" />
                  <button className="swiper-button-next" />
            ...
            <div className="col-md-6 sticky-sidebar-wrapper mb-4 mb-md-6">
              <div className="product-details sticky-sidebar" data-sticky-options="{'minWidth': 767}">
                ...
                <div className="product-price"><ins className="new-price">{/*{Data.price}*/} TND</ins></div>
            ...
            <div className="tab-content">
              <div className="tab-pane active" id="product-tab-description">
                  ...
                  <div className="col-md-6 mb-5">
                    <div className="banner banner-video product-video br-xs">
                      <figure className="banner-media">
                        <a href="#">
                          <img src="assets/images/products/video-banner-610x300.jpg" alt="banner" width={610} height={300} style={{backgroundColor: '#bebebe'}} />
                        </a>
                ...
                <div className="row cols-md-3">
                  <div className="mb-3">
                    <h5 className="sub-title font-weight-bold"><span className="mr-3">1.</span>Free
                      Shipping &amp; Return</h5>
                    <p className="detail pl-5">We offer free shipping for products on orders
                      above 50$ and offer free delivery for all orders in US.</p>
                  </div>
                  <div className="mb-3">
                    <h5 className="sub-title font-weight-bold"><span>2.</span>Free and Easy
                      Returns</h5>
                    <p className="detail pl-5">We guarantee our products and you could get back
                      all of your money anytime you want in 30 days.</p>
                  </div>
                  <div className="mb-3">
                    <h5 className="sub-title font-weight-bold"><span>3.</span>Special Financing
                    </h5>
                    <p className="detail pl-5">Get 20%-50% off items over 50$ for a month or
              ...
              <div className="tab-pane" id="product-tab-vendor">
                <div className="row mb-3">
                  <div className="col-md-6 mb-4">
                    <figure className="vendor-banner br-sm">
                      <img src="assets/images/products/vendor-banner.jpg" alt="Vendor Banner" width={610} height={295} style={{backgroundColor: '#353B55'}} />
                    </figure>
                  </div>
                  <div className="col-md-6 pl-2 pl-md-6 mb-4">
                    ...
                    <a href="vendor-dokan-store.html" className="btn btn-dark btn-link btn-underline btn-icon-right">Visit
                      Store<i className="w-icon-long-arrow-right" /></a>
                  </div>
                </div>
                <p className="mb-5"><strong className="text-dark">L</strong>orem ipsum dolor sit amet,
                ...
                <p className="mb-2"><strong className="text-dark">A</strong> arcu cursus vitae congue
              ...
              <div className="tab-pane" id="product-tab-reviews">
                  ...
                  <div className="col-xl-4 col-lg-5 mb-4">
                    <div className="ratings-wrapper">
                      ...
                      <div className="ratings-value d-flex align-items-center text-dark ls-25">
                        <span className="text-dark font-weight-bold">66.7%</span>Recommended<span className="count">(2 of 3)</span>
                      </div>
                ...
                <div className="tab tab-nav-boxed tab-nav-outline tab-nav-center">
                  <ul className="nav nav-tabs" role="tablist">
                    ...
                    <li className="nav-item">
                      <a href="#highest-rating" className="nav-link">Highest Rating</a>
                    </li>
                    <li className="nav-item">
                        ...
                        <li className="comment">
                          <div className="comment-body">
                            ...
                            <div className="comment-content">
                              ...
                              <div className="comment-action">
                                <a href="#" className="btn btn-secondary btn-link btn-underline sm btn-icon-left font-weight-normal text-capitalize">
                                  <i className="far fa-thumbs-up" />Helpful (0)
                                </a>
                                <a href="#" className="btn btn-dark btn-link btn-underline sm btn-icon-left font-weight-normal text-capitalize">
                                  <i className="far fa-thumbs-down" />Unhelpful
                                  (1)
            ...
            <div className="swiper-container swiper-theme" data-swiper-options="{
              ...
              <div className="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                ...
                <div className="swiper-slide product">
                  ...
                  <div className="product-details">
                    <div className="product-cat"><a href="shop-banner-sidebar.html">Sports</a>
                    </div>
                    <h4 className="product-name"><a href="product-default.html">Skate Pan</a>
                    </h4>
                    <div className="ratings-container">
                      <div className="ratings-full">
                        <span className="ratings" style={{width: '100%'}} />
