...
const About = () => {
  ...
  <div className="page-content become-a-vendor">
      ...
      <div className="row align-items-center">
        <div className="col-md-6 mb-4 mb-md-0">
          <figure className="br-sm">
            <img src="assets/images/pages/become/1.jpg" alt="Banner" width={610} height={435} style={{backgroundColor: '#D9D8DD'}} />
          </figure>
        </div>
            ...
            <div className="row cols-sm-2 mb-1">
              <div className="stage-item mb-6 stage-register d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" id="Layer_4" x="0px" y="0px" width="70px" height="70px" viewBox="0 0 70 70" xmlSpace="preserve">
                  <g>
                    <path d="M52.93,12.024H9.712v2.519H52.93V12.024z" />
                    <path d="M60.396,12.024h-3.545v2.519h3.545V12.024L60.396,12.024z" />
                    ...
                    <path d="M54.199,46.572h2.822v-2.521h-2.822V46.572z" />
                    <path d="M48.633,46.572h2.9v-2.521h-2.9V46.572z" />
                    <path d="M43.303,46.572h2.9v-2.521h-2.9V46.572z" />
                    ...
                    <path d="M52.502,30.325l-6.861-0.045l-0.281,0.063c-4.881,1.931-5.074,2.276-5.074,2.941v6.433h17.326v-6.433   C57.609,32.622,57.414,32.275,52.502,30.325z M52.045,32.11c1.6,0.639,3.104,1.296,3.742,1.633v4.145H42.105v-4.145   c0.643-0.336,2.152-0.992,3.76-1.633H52.045z" />
                    <path d="M30.32,21.914c0,0.693-0.563,1.261-1.253,1.261h-15.71c-0.69,0-1.254-0.566-1.254-1.261l0,0   c0-0.691,0.564-1.259,1.254-1.259h15.71C29.757,20.655,30.32,21.223,30.32,21.914L30.32,21.914z" />
                    <path d="M30.32,28.929c0,0.692-0.563,1.26-1.253,1.26h-15.71c-0.69,0-1.254-0.567-1.254-1.26l0,0   c0-0.692,0.564-1.258,1.254-1.258h15.71C29.757,27.671,30.32,28.236,30.32,28.929L30.32,28.929z" />
                    <path d="M19.978,34.999c0,0.692-0.565,1.26-1.255,1.26h-5.366c-0.69,0-1.254-0.566-1.254-1.26l0,0   c0-0.692,0.564-1.259,1.254-1.259h5.366C19.413,33.74,19.978,34.307,19.978,34.999L19.978,34.999z" />
                  </g>
                </svg>
              ...
              <div className="stage-item mb-6 stage-selling d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" id="Layer_3" x="0px" y="0px" width="70px" height="70px" viewBox="0 0 70 70" xmlSpace="preserve">
                  <g>
                    <rect x="27.456" y="23.221" width="16.526" height="1.854" />
                    <rect x="27.456" y="31.354" width="16.526" height="1.854" />
                    <rect x="27.456" y="39.598" width="16.526" height="1.854" />
                    <polygon points="20.892,25.005 18.584,23.058 17.824,23.95 21.042,26.667 25.252,21.568 25.316,21.491    24.408,20.748  " />
                    <polygon points="20.892,33.138 18.584,31.19 17.824,32.083 21.042,34.799 25.252,29.701 25.316,29.624    24.408,28.88  " />
                    <polygon points="20.892,40.793 18.584,38.846 17.824,39.738 21.042,42.457 25.252,37.355 25.316,37.279    24.408,36.535  " />
                    <polygon points="20.892,49.141 18.584,47.191 17.824,48.086 21.042,50.802 25.252,45.704 25.316,45.627    24.408,44.884  " />
                    ...
                    <polygon points="47.646,56.266 44.559,53.249 43.497,54.314 47.749,58.475 48.305,57.832 53.958,51.007    52.791,50.052  " />
                  </g>
                </svg>
              ...
              <div className="stage-item mb-5 stage-get d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" id="Layer_2" x="0px" y="0px" width="70px" height="70px" viewBox="0 0 70 70" xmlSpace="preserve">
                  <g>
                    <path d="M11.3,54.3H41V37.4H11.3V54.3z M32.6,40h5.9v11.8h-5.9V40z M22.9,40H30v11.8h-7.1V40z M13.8,40h6.5v11.8   h-6.5V40z" />
      ...
      <div className="container mt-0 mt-lg-10 mb-2 mb-lg-9">
        <div className="row">
          <div className="col-lg-4 mb-4 mb-lg-0">
            ...
            <h2 className="title text-left ls-25">Success stories from Wolmart sellers</h2>
            ...
            <a href="vendor-dokan-store.html" className="btn btn-dark btn-link btn-underline btn-icon-right">
              Visit Vendors<i className="w-icon-long-arrow-right" /></a>
          </div>
          {/* End of Col */}
                ...
                <div className="swiper-wrapper row cols-sm-2">
                    ...
                    <div className="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                      <div className="testimonial-info">
                        <figure className="testimonial-author-thumbnail">
                          <img src="assets/images/agents/1-100x100.png" alt="Testimonial" width={100} height={100} />
                        </figure>
                  ...
                  <div className="swiper-slide testimonial-wrap">
                    <div className="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                      <div className="testimonial-info">
                        <figure className="testimonial-author-thumbnail">
                          <img src="assets/images/agents/2-100x100.png" alt="Testimonial" width={100} height={100} />
                        </figure>
                        <div className="ratings-container">
                          <div className="ratings-full">
                            <span className="ratings" style={{width: '100%'}} />
                  ...
                  <div className="swiper-slide testimonial-wrap">
                    <div className="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                      <div className=" testimonial-info">
                        <figure className="testimonial-author-thumbnail">
                          <img src="assets/images/agents/3-100x100.png" alt="Testimonial" width={100} height={100} />
                        </figure>
                        <div className="ratings-container">
                          <div className="ratings-full">
                            <span className="ratings" style={{width: '100%'}} />
    ...
    <div className="container questions mt-2 mt-lg-10 mb-5 mb-lg-9">
      <h4 className="text-center text-primary font-weight-bold text-capitalize ls-25">Frequently Asked Questions</h4>
    ...
    {/* End of Container */}
    <div className="banner parallax" data-parallax-options="{'speed': 10, 'parallaxHeight': '200%', 'offset': -99}" data-image-src="assets/images/pages/become/3.jpg" style={{backgroundColor: '#929294'}}>
      <div className="container">
